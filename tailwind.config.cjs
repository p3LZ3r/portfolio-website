...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        primary: '0px 1px 8px 0px rgba(0, 0, 0, 0.1), 0px 0px 2px 0px rgba(0, 0, 0, 0.1)',
        inset: 'inset 0px 0px 8px 0px rgba(242, 242, 242, 1), inset 0px 0px 0px 1px rgba(166, 166, 166, 1), inset -2px -2px 0.5px -2px rgba(38, 38, 38, 1), inset 2px 2px 0.5px -2px rgba(38, 38, 38, 1), inset 3px 3px 0.5px -3.5px rgba(255, 255, 255, 1)',
      },
      transitionDuration: {
        fast: '0.2s',
        normal: '0.3s',
