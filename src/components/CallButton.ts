...
export class CallButton extends LitElement {
  ...
  @property({ type: String }) label = "Schedule a call";
  @property({ type: String }) href = "https://cal.com/tlinnecke/45min";
  @property({ type: Boolean, attribute: "new-tab" }) openInNewTab = true;
